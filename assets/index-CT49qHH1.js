function yP(e,t){for(var n=0;n<t.length;n++){const r=t[n];if(typeof r!="string"||!r)throw new Error("Expected string in array")}const i=[];for(n=0;n<t.length;n++)i.push(pL(e[t[n]]));return i.join("\n")}
